    ...
    <body>
	 ...
	 <?php
			...
			if(isset($_POST['update'])) {
				 ...
				 $sql = mysql_query("UPDATE produtos SET nome = '$nome', preco = '$preco', imagem = '$imagem' WHERE id = '$id'");
							if(! $sql ) {
				 ...
				 ?>
						<form method = "post" action = "<?php $_PHP_SELF ?>">
							<div class="control-group">
							 ...
							 <div class="controls">
								 <input type="text" required name="nome" value="<?php echo $nome; ?>" class="input-xlarge"/>
								 </div>
					 </div>
					 <div class="control-group">
