										...
										if($value > 0)
										{
											if(substr($nome, 0, 5) == 'cart_')
											{
												...
												while($get_row = mysql_fetch_array($get)){
													...
													$data = mysql_fetch_array($getcompras);
											...
											mysql_query("INSERT INTO compras VALUES('', '1', '$prod', '5', '$sub', now())") or die(mysql_error());
										}
									}
							  }
							  else
							  {
									...
									foreach($_SESSION as $nome => $value)
									{
										if($value > 0)
										{
											...
											mysql_query("INSERT INTO compras VALUES('', '$cli', '$prod', '$value', '$sub', now()) ") or die(mysql_error());
										}
									}
							  }
							  session_destroy();
